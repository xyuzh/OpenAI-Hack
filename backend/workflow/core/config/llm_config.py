...
class LLMConfig(BaseModel):
    ...
    Attributes:
        ...
        custom_llm_provider: The custom LLM provider to use. This is undocumented in usebase, and normally not used. It is documented on the litellm side.
    ...
    openrouter_app_name: str = Field(default='usebase')
