...
from workflow.core.exceptions import LLMResponseError
# from workflow.events.event import Event
# from workflow.events.observation import CmdOutputMetadata
# from workflow.events.serialization import event_to_dict
from workflow.llm.metrics import Metrics


class usebaseJSONEncoder(json.JSONEncoder):
...
_json_encoder = usebaseJSONEncoder()
...
def dumps(obj, **kwargs):
    ...
    if 'cls' not in encoder_kwargs:
        encoder_kwargs['cls'] = usebaseJSONEncoder
