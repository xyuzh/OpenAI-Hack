...
# NOTE: we need to make sure this example is always in-sync with the tool interface designed in usebase/agenthub/codeact_agent/function_calling.py
...
Requirement already satisfied: Jinja2>=3.1.2 in /home/usebase/.local/lib/python3.10/site-packages (from flask) (3.1.3)
Requirement already satisfied: MarkupSafe>=2.0 in /home/usebase/.local/lib/python3.10/site-packages (from Jinja2>=3.1.2->flask) (2.1.5)
            ...
            if not first_user_message_encountered and add_in_context_learning_example:
                ...
                if not (
                    ...
                    raise FunctionCallConversionError(
                        ...
                        'Please update your tool set OR the in-context learning example in usebase/llm/fn_call_converter.py'
                    )
